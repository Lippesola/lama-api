...
class DocumentController {
	...
	static getCriminalRecordContent(doc, user) {
	...
	static getParticipatorConfirmation(doc, participator) {
...
// Named re-exports fuer bestehende Imports in anderen Controllern
export const createDocument = DocumentController.createDocument
export const getHeader = DocumentController.getHeader
export const getCriminalRecordContent = DocumentController.getCriminalRecordContent
export const getParticipatorConfirmation = DocumentController.getParticipatorConfirmation
export const getSidebar = DocumentController.getSidebar
